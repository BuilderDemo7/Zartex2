...
-- Mission 1
local Mission1 = PACKAGE.CreateMission("Paramedics Incidental",5,0,0,0)
PACKAGE.AddMission(Mission1, 1) -- mission, sub ID

-- This is the logic start of the "Mission 1"
local Mission1_LogicStart = Mission1.LogicStart(1,"Paramedics Incidental - Start")

local Ambulance = Mission1.CreateVehicle(84.05503082, 0.9875760078, 152.2644196, -90, 25,  1, 20, 0, 0.333, 0.5, 0.6667, 0.6667, nil, "Ambulance"--[[, 26214401]])
local Paramedic = Mission1.CreateCharacter(84.05503082, 0.9875760078, 152.2644196, -90, 92,  1.0,  0.0,  Ambulance, 0, 0, false, 1)
Mission1.CountActor(Paramedic)
Mission1.CountActor(Ambulance)

local mission1_timer = Mission1.SetFadeOut(0.5)
Mission1_LogicStart.Wires.Add(mission1_timer)
-- in 0.01 secs
mission1_timer.Wires.Add(Mission1.GiveActorCreation(Ambulance))
mission1_timer.Wires.Add(Mission1.ShowMarkerOnActor(Paramedic, 0, 2)) -- Show a marker on it
mission1_timer.Wires.Add(Mission1.Wanderer(Paramedic, 23, 0.8)) -- Make him drive around
...
Mission1.JobComplete(1) -- important to start the next mission?